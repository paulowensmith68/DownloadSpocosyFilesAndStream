...
Public Class DownloadSpocosyFilesService
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        gobjEvent.WriteToEventLog("Service Start Banner:    *     DownloadSpocosyFilesAndStream STARTING   *")
        gobjEvent.WriteToEventLog("Service Start Banner:    ************************************************")
...
Public Class Worker
    ...
    Public Sub StopWork()
        ...
        gobjEvent.WriteToEventLog("Service Stopping Banner: *       DownloadSpocosyFilesAndStream STOPPED       *")
        gobjEvent.WriteToEventLog("Service Stopping Banner: ************************************************")
    ...
    Function StartProcess() As Boolean
        ...
        Try
            ...
            gobjEvent.WriteToEventLog("StartProcess:    *---DownloadSpocosyFilesAndStream Process Start----")
            gobjEvent.WriteToEventLog("StartProcess:    *--------------------------------------------------")
